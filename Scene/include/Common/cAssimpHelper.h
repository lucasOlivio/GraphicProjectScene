...
//#define AI_MATKEY_SHADER_COMPUTE "?sh.cs", 0, 0
	...
	public:
		...
		bool Load3DModelFile(std::string filename, ModelDrawInfo* drawInfo);
		bool Load3DModelFile(std::string filename, sPostProcessFlags postProcessOptions, ModelDrawInfo* drawInfo);
