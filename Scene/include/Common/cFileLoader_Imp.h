...
public:
	...
	bool Load3DModelFile(std::string filename, AssimpHelper::cFileLoader::sPostProcessFlags postProcessOptions, ModelDrawInfo* drawInfo);
...
private:
	...
	bool m_ProcessScene(const aiScene* scene, ModelDrawInfo* drawInfo);
