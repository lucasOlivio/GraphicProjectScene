...
bool AssimpHelper::cFileLoader::Load3DModelFile(std::string filename, ModelDrawInfo* drawinfo)
{
...
bool AssimpHelper::cFileLoader::Load3DModelFile(std::string filename, sPostProcessFlags postProcessOptions, ModelDrawInfo* drawinfo)
{
