...
bool cFileLoader_Imp::m_ProcessScene(const aiScene* scene, ModelDrawInfo* drawInfo)
{
	...
	drawInfo->pVertices = new Vertex[drawInfo->numberOfVertices];
...
bool cFileLoader_Imp::Load3DModelFile(std::string filename, AssimpHelper::cFileLoader::sPostProcessFlags postProcessOptions, ModelDrawInfo* drawInfo)
{
